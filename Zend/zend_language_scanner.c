...
static zend_always_inline const char* token_to_name(token)
{
    switch (token) {
        case END                        : return "END";
        ...
        case T_PAAMAYIM_NEKUDOTAYIM     : return "T_PAAMAYIM_NEKUDOTAYIM";
...
static zend_always_inline int emit_token(int token, int token_line)
{
	...
	const char* token_name = token_to_name(token);
	if (NULL != token_name) {
        if (T_WHITESPACE != token) {
			printf("[LINE: %2d] TOKEN: %s\n", token_line, token_name);
        }
	} else {
		printf("[LINE: %2d] TOKEN: %c\n", token_line, (char)token);
	}
...
#line 1265 "Zend/zend_language_scanner.c"
{
	YYCTYPE yych;
...
#line 2299 "Zend/zend_language_scanner.c"
yy71:
		YYDEBUG(71, *YYCURSOR);
		++YYCURSOR;
		YYFILL(1);
...
#line 2699 "Zend/zend_language_scanner.c"
yy123:
...
#line 2725 "Zend/zend_language_scanner.c"
yy128:
...
#line 3829 "Zend/zend_language_scanner.c"
yy280:
...
#line 4098 "Zend/zend_language_scanner.c"
yy319:
...
#line 7932 "Zend/zend_language_scanner.c"
}
